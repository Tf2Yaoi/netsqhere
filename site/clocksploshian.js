...
function bang(N) {
    ...
    if (A != sparks) timers[N] = setTimeout(function () { bang(N); }, speed);
}
...
function eksplode(e) {
    ...
    set_scroll();
    if (!e) e = window.event;
    if (typeof e.pageY === "number" && typeof e.pageX === "number") {
        y = e.pageY;
        x = e.pageX;
    } else if (typeof e.clientY === "number" && typeof e.clientX === "number") {
        y = e.clientY + sdown;
        x = e.clientX + sleft;
    } else {
        y = 0;
